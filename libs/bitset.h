...
// возвращает значение "истина" если set1 является строгим включением в set2 иначе "ложь"
int bitset_strictInclusion(bitset set1, bitset set2);

// возвращает значение "истина" если set1 является нестрогим включением в set2 иначе "ложь"
int bitset_nonStrictInclusion(bitset set1, bitset set2);

// вывод множества set
void bitset_print(bitset set);

// возвращает максимальное значение множества set
unsigned bitset_get_maxValue(uint32_t values);
